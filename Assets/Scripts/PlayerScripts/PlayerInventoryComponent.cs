...
public sealed class PlayerInventoryComponent : MonoBehaviour
{
    ...
    public void SetSelectedHotbarStack(ItemStack stack)
    {
        Model.Hotbar.SetSlot(SelectedHotbarIndex, stack);
    }
    ...
    public void ConsumeSelectedHotbarItem()
    {
        var hotbar = Model.Hotbar;
        ItemStack stack = hotbar.GetSlot(SelectedHotbarIndex);
        stack.Quantity -= 1;
        hotbar.SetSlot(SelectedHotbarIndex, stack);
    }
}
